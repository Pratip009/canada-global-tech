...
export default function TechnologiesWeUse() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-white via-gray-50 to-gray-100 py-24 px-6 md:px-16 lg:px-24 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-72 h-72 bg-teal-200/30 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-yellow-200/30 rounded-full blur-3xl -z-10" />
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="px-8 py-3 rounded-full text-white font-semibold text-base shadow-lg bg-gradient-to-r from-teal-500 via-blue-500 to-yellow-400 bg-[length:200%_100%] transition-all duration-500"
          >
        ...
        >
          {techList.map((tech, index) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center h-36 bg-white hover:bg-gradient-to-br hover:from-gray-50 hover:to-gray-100 transition-all duration-300"
            >
              <Image
                src={tech.logo}
                alt={tech.name}
